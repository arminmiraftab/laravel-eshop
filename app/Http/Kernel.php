...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'isadmina' => \App\Http\Middleware\isadmin::class,
        'istimefa' => \App\Http\Middleware\istimefa::class,
        'islogin' => \App\Http\Middleware\islogincustomer::class,
        'EmptyCart' => \App\Http\Middleware\EmptyCart::class,
