    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>مدیر ها</h2>
            ...
            <div class="box-content">
                ...
                <table id="userTable" class="table  table-bordered ">
                    ...
                    <tr>
                        ...
                        <th align="center" style="text-align: center !important">سطح دسترسی</th>
                ...
                success: function (response) {
                    ...
                    if (len > 0) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            if(response['data'][i].roll==null) {status_rule = Null;}else {status_rule=rule;}
                            // var phone_save;
                            // var ID_cart_save;
                            // if(rule==null) {status_rule = Null;}else {status_rule=rule;}
                            if(rule==null) {status_rule = "user";}
                            // if (phone == null) {
                            ...
                            var tr_str = "<tr style='padding: 0;'>" +
                                ...
                                "<td style='padding: 0;text-align: center' align='center '> <span  class='label label-success'>" + status_rule + "</span></td>" +
                                // "<td style='padding: 0;text-align: center' class='center'>" + phone_save + "</2td>" +
                                // "<td style='padding: 0;text-align: center' class='center'>" + ID_cart_save + "</td>" +
                                "<td align='center'> <a class='btn btn-info'   href='/admin/Edite_roll_admin/" + id + "'><i class='halflings-icon white edit'></i></a> <button name='delet' id='" + id + "' class='btn btn-danger delet'><i class='halflings-icon white trash'></i></button>  </td>" +
                                "</tr>";
